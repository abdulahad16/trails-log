/*
 * Title:   Ekoders | Responsive HTML5 Travel Template - Main Javascript file
...
function changeEkodersElementUI() {
...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo1 navbar-brand"><a title="Ekoders - home" href="index.html"><h5>Trails Log</h5></a></h1>').insertBefore('.chaser .menu');
...
// login box
tjq("body").on("click", ".Ekoders-signup-box .signup-email", function(e) {
    e.preventDefault();
    tjq(this).closest(".Ekoders-signup-box").find(".simple-signup").hide();
    tjq(this).closest(".Ekoders-signup-box").find(".email-signup").show();
    tjq(this).closest(".Ekoders-signup-box").find(".email-signup").find(".input-text").eq(0).focus();
});
