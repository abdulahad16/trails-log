...
<head>
    <!-- Page Title -->
    <title>Ekoders | Responsive HTML5 Travel Template</title>
    
    <!-- Meta Tags -->
    <meta charset="utf-8">
    <meta name="keywords" content="HTML5 Template" />
    <meta name="description" content="Ekoders | Responsive HTML5 Travel Template">
    ...
    <div id="page-wrapper">
        <header id="header" class="navbar-static-top">
            <div class="topnav hidden-xs">
                <div class="container">
                    ...
                    <ul class="quick-menu pull-right">
                        <li><a href="#Ekoders-login" class="soap-popupbox">LOGIN</a></li>
                        <li><a href="#Ekoders-signup" class="soap-popupbox">SIGNUP</a></li>
            ...
            <div class="main-header">
                ...
                <div class="container">
                    <h1 class="logo1 navbar-brand">
                        <a href="index.html" title="Ekoders - home">
                           <!--  <img src="images/logo.png" alt="Ekoders HTML5 Template" /> -->
                           <h2>Trails Log</h2>
                        </a>
                    </h1>
                    ...
                    <nav id="main-menu" role="navigation">
                        <ul class="menu">
                            ...
                            <li class="menu-item-has-children">
                                <a href="hotel-index.html">Plans</a>                                
                            </li>
                            <li class="menu-item-has-children">
                                <a href="flight-index.html">Tours</a>                                
                            </li>
                            <li class="menu-item-has-children">
                                <a href="car-index.html">Hollydays</a>                                
                            </li>
                                        ...
                                        <ul class="megamenu">
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="clearfix">
                                                    ...
                                                    <li><a href="pages-Ekoders-policies.html">Ekoders Policies</a></li>
            ...
            <div id="Ekoders-signup" class="Ekoders-signup-box Ekoders-box">
                ...
                <div class="simple-signup">
                    ...
                    <p class="description">By signing up, I agree to Ekoders's Terms of Service, Privacy Policy, Guest Refund olicy, and Host Guarantee Terms.</p>
                </div>
                <div class="email-signup">
                    <form>
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox"> Tell me about Ekoders news
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <p class="description">By signing up, I agree to Ekoders's Terms of Service, Privacy Policy, Guest Refund Policy, and Host Guarantee Terms.</p>
                        </div>
                        <button type="submit" class="full-width btn-medium">SIGNUP</button>
                    </form>
                </div>
                <div class="seperator"></div>
                <p>Already a Ekoders member? <a href="#Ekoders-login" class="goto-login soap-popupbox">Login</a></p>
            </div>
            <div id="Ekoders-login" class="Ekoders-login-box Ekoders-box">
                <div class="login-social">
                    <a href="#" class="button login-facebook"><i class="soap-icon-facebook"></i>Login with Facebook</a>
                    <a href="#" class="button login-googleplus"><i class="soap-icon-googleplus"></i>Login with Google+</a>
                </div>
                ...
                <form>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <button class="full-width btn-medium" type="submit">LOGIN</button>
                    </div>
                </form>
                <div class="seperator"></div>
                <p>Don't have an account? <a href="#Ekoders-signup" class="goto-signup soap-popupbox">Sign up</a></p>
            </div>
        </header>